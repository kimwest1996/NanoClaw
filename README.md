...
```bash
# 克隆项目
git clone https://github.com/ttguy0707/NanoClaw.git
cd NanoClaw
...
[![Star History Chart](https://api.star-history.com/svg?repos=ttguy0707/NanoClaw&type=Date)](https://star-history.com/#ttguy0707/NanoClaw&Date)
